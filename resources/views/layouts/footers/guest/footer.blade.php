<footer class="footer has-cards">
    <div class="container container-lg">
        <div class="row">
            ...
            // Mengambil data pengaduan dengan pagination
            $pengaduan = Pengaduan::where('status_pengaduan', 'Diproses')->paginate(6);
            ?>
            @foreach ($pengaduan as $item)
                <div class="col-md-6 mb-5 mb-md-0">
                    <div class="card card-lift--hover shadow border-0">
                        <a href="#" title="Detail Pengaduan">
                            <img src="{{ asset('uploads/' . $item->foto_barang) }}" class="card-img">
                        </a>
                    </div>
                </div>
            @endforeach
