...
<body>
        ...
        <div class="col-lg-6 mb-2" style="margin-left: 15px;">
            <div class="card h-100">
                ...
                <!-- <div class="text-center" style="margin-top: -35px;">
                    <button class="col-lg-6 btn btn-danger" onclick="confirmSelesaiPresensi()">
                        <i class="fa-solid fa-stop" style="margin-right: 5px;"></i>Selesai
                    </button>
                </div> -->
    ...
    scanner.addListener('scan', function(content) {
        ...
        fetch('{{ route('process-presensi', $data->id) }}', {
                    method: 'POST',
                    headers: {
    ...
    function fetchDataAbsensi() {
        fetch('{{ route('update-absen-scan', $data->id) }}')
    ...
    // function confirmSelesaiPresensi() {
    //     Swal.fire({
    //         title: 'Anda yakin ingin menyelesaikan sesi presensi?',
    ...
    //             // Redirect atau route(selesai-presensi, $data->id_sesi)
